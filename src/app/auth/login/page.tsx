      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 flex-col justify-between p-12">
        ...
        <div>
          <blockquote className="text-2xl font-light text-white leading-relaxed mb-6">
            "Closed 3x more deals in the first month. The pipeline view is exactly what our team needed."
          </blockquote>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm">Head of Sales, NeuralTech</p>
            </div>
          </div>
        </div>
        <div className="grid grid-cols-3 gap-4">
          {[['10k+', 'Leads managed'], ['98%', 'Uptime SLA'], ['4.9★', 'Customer rating']].map(([stat, label]) => (
